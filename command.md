...
mv [옵션] [이동할 파일명] [이동할 위치]    
```
# test1 파일을 study 디렉토리로 이동
$ mv test1 /home/yun/study

# 대상파일이 존재하면 백업파일 생성 / test1~ 백업파일
$ mv -b test1 /home/yun/study

# 사용자에게 묻지 않고 파일을 덮어씀
$ mv -f test1 ./study

# 파일이 존재할경우 덮어쓸지 여부 확인
$ mv -i test1 ./study
...
#[원본파일명]이 경로일 경우, 그 경로에 있는 하위 디렉토리를 포함해 모두 복사
$ cp -r file copypath
```   
